  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto box-border w-full max-w-[1280px] px-[32px] pt-[128px] pb-[128px] min-[1280px]:pt-[192px]">
        <div className="flex flex-col items-start gap-[64px] lg:flex-row lg:items-center lg:justify-between lg:gap-[32px] min-[1280px]:h-[478px] min-[1280px]:gap-[0px]">
          <Reveal className="flex w-full max-w-[576px] flex-col items-start gap-[24px] lg:w-[calc(50%-16px)] lg:max-w-none min-[1280px]:w-[576px] min-[1280px]:max-w-[576px] min-[1280px]:translate-y-[-18.5px]">
            ...
            <div className="flex w-full max-w-[576px] flex-wrap items-center gap-[12px] pt-[4px]">
            ...
            <div className="flex w-full max-w-[576px] items-center gap-[12px] pt-[24px]">
              <span className="flex h-[21px] w-[22px] shrink-0 items-center justify-center text-brand">
                <svg
                  aria-hidden="true"
              ...
              <span className="w-full max-w-[468.88px] font-body text-[14px] font-[500] leading-[20px] text-faded">
                {hero.supportNote}
              </span>
            </div>
          </Reveal>

          <Reveal delay={0.08} className="relative h-[392px] w-full max-w-[576px] shrink-0 lg:h-[400px] lg:w-[calc(50%-16px)] lg:max-w-none min-[1280px]:h-[432px] min-[1280px]:w-[576px] min-[1280px]:max-w-[576px] min-[1280px]:translate-y-[23px]">
            <div className="relative mx-auto h-[392px] w-full max-w-[576px] lg:h-[400px] lg:max-w-none min-[1280px]:h-[432px] min-[1280px]:max-w-[576px]">
