...
export function HowItWorksSection({ howItWorks }) {
  return (
    <section id="how-it-works" className="surface-texture border-t border-border/20 bg-surface py-[56px] sm:py-[68px] lg:py-[104px]">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center gap-[36px] px-[16px] sm:px-[24px] md:px-[32px] lg:gap-[64px]">
