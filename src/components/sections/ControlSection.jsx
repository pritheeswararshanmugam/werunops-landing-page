...
export function ControlSection({ control }) {
  return (
    <section id="control" className="surface-texture bg-section py-[128px] text-ink" style={SECTION_SHADOW_STYLE}>
      <div className="relative mx-auto flex w-full max-w-[1280px] flex-col gap-[48px] px-[20px] md:px-[32px] lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-center lg:gap-[40px]">
        <Reveal className="flex w-full flex-col gap-[24px] lg:min-w-0">
